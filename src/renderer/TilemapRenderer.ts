...
const TILE_SPRITE: Record<string, string> = {
  // Plains
  grass:              'Ground/Grass',
  grass_tall:         'Ground/GrassTall',
  flower_yellow:      'Ground/GrassFlowerYellow',
  flower_red:         'Ground/GrassFlowerRed',
  dirt_path:          'Ground/DeadGrass',
  rock_small:         'Nature/RockSmall',
  rock_large:         'Nature/RocksBig',
  // Forest
  grass_dark:         'Ground/GrassTall',
  tree_oak:           'Nature/Trees',
  tree_pine:          'Nature/PineTrees',
  tree_dead:          'Nature/DeadTrees',
  bush:               'Nature/Trees',
  mushroom:           'Ground/GrassTall',
  log:                'Nature/DeadTrees',
  moss_rock:          'Nature/RocksBig',
  ...
  mud:                'Ground/GrassTall',
  // Desert
  sand:               'Ground/GrassTall',
  sand_dune:          'Ground/GrassTall',
  dry_rock:           'Nature/RockSmall',
  cactus:             'Nature/Cactus',
  dry_grass:          'Nature/Tumbleweed',
  oasis_water:        'Ground/Shore',
  quicksand:          'Ground/GrassTall',
  // Village
  cobblestone:        'Ground/GrassTall',
