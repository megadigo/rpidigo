...
export const recipes: RecipeDefinition[] = [
  ...
  { id: 'recipe_wooden_bow',    produces: 'wooden_bow',    quantity: 1, requires: [{ itemId: 'wood', qty: 4 }, { itemId: 'leather', qty: 1 }],             station: 'workbench',       levelRequired: 1 },
  ...
  { id: 'recipe_health_potion',      produces: 'health_potion',      quantity: 2, requires: [{ itemId: 'mushroom_item', qty: 2 }],                            station: 'workbench',  levelRequired: 1 },
  ...
  { id: 'recipe_iron_bow',       produces: 'iron_bow',      quantity: 1, requires: [{ itemId: 'iron_bar', qty: 2 }, { itemId: 'wood', qty: 3 }, { itemId: 'leather', qty: 1 }], station: 'workshop', levelRequired: 4 },
